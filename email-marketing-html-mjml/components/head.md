...
MJML's own default breakpoint is **480px** — a template with no `<mj-breakpoint>` emits `@media only screen and (max-width:479px)`. This is unrelated to the 600px `mj-body` width.
